...
from ffci.models import AsyncResponse, Job, AnyJSON
...
def github_event(request: Request, x_hub_signature: Annotated[str | None, Header()] = None,
                 x_github_event:  Annotated[str | None, Header()] = None) -> AsyncResponse:
